...
export const LoginPage: React.FC<LoginPageProps> = ({ onLogin, onGoogleLogin, onBack }) => {
      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl shadow-slate-200/50 overflow-hidden">
        ...
        <div className="p-8 pt-12">
          ...
          <button 
            ...
            className="w-full bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 font-semibold py-3.5 rounded-xl transition-all flex items-center justify-center gap-3 mb-6 shadow-sm"
          >
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-white text-slate-400">ou continue com email</span>
            </div>
          </div>
